                ...
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr>
                            ...
                            <th class="wd-15p">Category Name It</th>
                ...
                <div class="modal-content tx-size-sm">
                    ...
                    <form method="post" action="{{ route('store.blog.category') }}">
                        ...
                        <div class="modal-body pd-20">
                            ...
                            <div class="modal-body pd-20">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Category Name Italian</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name Italian" name="category_name_it">

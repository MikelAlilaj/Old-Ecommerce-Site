                ...
                <form method="post" action="{{route('store.post')}}" enctype="multipart/form-data">
                    ...
                    <div class="form-layout">
                        <div class="row mg-b-25">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label">Post Title(ITALIAN): <span class="tx-danger">*</span></label>
                                    <input class="form-control" type="text" name="post_title_it"   placeholder="Enter Post Title in Italian">
                                </div>
                            </div><!-- col-4 -->
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label">Product Details(ITALIAN): <span class="tx-danger">*</span></label>
                                    <textarea class="form-control" id="summernote1"   name="details_it">
